...
# tss1 = get_TS(layers["SC_FINE"], layers["SC_FINE"], 200, 100, [1, 0.5, 0.3], 10)
# layout.add_element(tss1.get_copy().move(3490, 1200))
# layout.add_element(tss1.get_copy().move(3490, 4500-320))

layout.build()
# layout.build_to_file(
#     r"/home/jyrgen/Documents/PhD/design_files/MR00_v3_200pH_11_7eps_20251002.gds"
# )