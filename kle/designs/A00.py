...
res.add_element(KleShape(
    ...
    [
        (0, 0), (RES_GAP, 0),
        (RES_GAP, -RES_WIDTH - 2 * RES_GAP), (0, -RES_WIDTH - 2 * RES_GAP)
    ]
).move(COUPLING_WIDTH, RES_GAP + RES_WIDTH/2))

layout.add_element(res.move(200, 4388))
...
layout.build()
layout.save_gds("C:/Users/nbr720/Documents/PhD/design/gds_files/A00_20240522.dxf")