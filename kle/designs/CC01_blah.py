...
bt_cap = 0.5e-12
freq_target = 3.96e9 # 4.5e9
filter_ind = calculate_filter_react(bt_cap, bt_ind, freq_target * 6.28)/(6.28 * freq_target)
...
print("Compare ind", mL * 2, gndClen)
...
ftr_path = [
    (0, 0), (0, -100), (100+33.848, -100), (100 + 33.848, -245)
]
filter_to_res, ftr_len = get_routed_trace(layers["SC"], ftr_path, width_start=2, width_end=2, radii=5)
res0.add_element(filter_to_res.move(cL + 15 - 5/2, -155))

tot_filter_ind = ftr_len * LSHEET/2 + filter_ind

# tot_filter_ind = 70e-9
print(tot_filter_ind, gndClen * LSHEET/2)
print("freq target", freq_target, "design",
    1/(res_cap * parall(gndClen * LSHEET/2, tot_filter_ind))**0.5/(2e9 * 3.14)
)

layout.add_element(res0.move(1100, 2937.5))
# layout.add_element(res0)
