...
# ==== COUPLER DEFAULTS ====
COUPLER_DISTANCE = 3 + COMPENSATION
COUPLER_HEIGHT = 10
COUPLER_GAP = 6
...
RES_WIDTH_GAPS = [(7, 4), (7, 4), (7, 4), (2, 10), (2, 10), (2, 10)]
...
for c_w, l, pos, mask, wg in zip(COUPLER_WIDTHS, RESONATOR_LEN, RESONATOR_POS, MASK, RES_WIDTH_GAPS):
    if mask:
        res = get_resonator(layers["sc"], l, wg[0], wg[1])
...
layout.build()
layout.save_gds("C:/Users/nbr720/Documents/PhD/design/gds_files/V00_20240422.gds")